...
GridLayout {
    ...
    Timer { interval: 1000; repeat: true; running: widgets.visible && widgets.service.telemetryAvailable; onTriggered: widgets.advance() }
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Ui.Label { text: widgets.service.telemetryAvailable ? "DEMO / 48s" : "UNAVAILABLE"; font.pixelSize: 9; color: Ui.Theme.muted }
            }
            Canvas {
                id: graph
                ...
                Accessible.name: available ? "Simulated CPU and GPU utilization history" : "System telemetry unavailable"
                onPaint: {
                    ...
                    for (let seriesIndex = 0; seriesIndex < history.length; seriesIndex++) {
                        ...
                        for (let pointIndex = 0; pointIndex < values.length; pointIndex++) {
                            ...
                            if (pointIndex === 0) context.moveTo(abscissa, ordinate);
            ...
            Repeater {
                ...
                RowLayout {
                    ...
                    Ui.Label { text: widgets.service.telemetryAvailable ? modelData.value + "%" : "N/A"; font.pixelSize: 10; Layout.preferredWidth: 34 }
